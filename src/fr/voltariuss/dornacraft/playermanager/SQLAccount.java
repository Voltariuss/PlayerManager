...
/**
 * Classe comportant les requêtes SQL relatives à la gestion du compte des
 * joueurs
 * 
 * @author Voltariuss
 * @version 1.4.0
...
public final class SQLAccount {
	 ...
	 * @param target
	 *            Le joueur ciblé, non null
	 * @return True si le joueur possède un compte, false sinon
	 * @throws SQLException
	 *             Si une erreur avec la base de données est détectée
	 */
	 ...
	 * 
	 * @param playerName
	 *            Le nom du joueur ciblé, non null
