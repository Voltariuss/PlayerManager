...
public final class PermissionManager {
	...
	/**
	 * Récupère les permissions spécifiques du joueur dans la mémoire centrale si il
	 ...
	 * 
	 * @param sender
	 *            L'émetteur de la requeête, peut être null
	 * @param target
	 *            Le joueur ciblé, non null
	 * @param permission
	 *            La permission à retirer, non null
	 * @throws SQLException
	 *             Si une erreur avec la base de données est détectée
	 */
	 ...
	 *            Le joueur ciblé, non null
	 * @param permission
	 *            La permission à vérifier par rapport au joueur, non null
	 * @return True si le joueur possède la permission, false sinon
	 * @throws SQLException
	 *             Si une erreur avec la base de données est détectée
	 */
	 ...
	 * @param target
	 *            Le joueur ciblé, non null
	 * @return True si le joueur possède au moins une permission, false sinon
	 * @throws SQLException
	 *             Si une erreur avec la base de données est détectée
	 */
