...
public final class UtilsPlayerManager {
	...
	public static final String PREFIX_NOT_OWNED = "Vous ne possèdez pas ce préfixe.";
	...
	// Messages d'erreur
	public static final String RANK_HAS_HIGHEST = "Le joueur possède déjà le rang le plus élevé.";
	...
	public static final String SUBRANK_NOT_OWNED_SPECIFICATION = "Vous ne possèdez pas le sous-rang : %s§r.";
